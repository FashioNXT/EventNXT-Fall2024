...
class GuestsController < ApplicationController
  ...
  before_action :get_event, except: %i[book_seats update_commited_seats]
  # <!--===================-->
  ...
  skip_before_action :authenticate_user!, only: %i[book_seats update_commited_seats]
  ...
  def import_guests_csv
    ...
    (2..spreadsheet.last_row).each do |i|
      ...
      guest = Guest.find_or_initialize_by(first_name:, last_name:, event_id:)
  ...
  def guest_params
    params.require(:guest).permit(:first_name, :last_name, :email, :affiliation, :category, :section, :alloted_seats,
