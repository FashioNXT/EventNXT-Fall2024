  ...
  test 'should create guest' do
    assert_difference('Guest.count') do
      ...
      post event_guests_path,
        params: { guest: { affiliation: @guest.affiliation,
                           alloted_seats: @guest.alloted_seats, category: @guest.category, commited_seats: @guest.commited_seats, event_id: @guest.event_id, first_name: @guest.first_name, guest_commited: @guest.guest_commited, last_name: @guest.last_name, status: @guest.status } }
    end
